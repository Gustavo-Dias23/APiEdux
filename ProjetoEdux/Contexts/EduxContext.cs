...
namespace ProjetoEdux.Contexts
{
    public partial class EduxContext : DbContext
    {
        ...
        public EduxContext()
        {
            con.ConnectionString = @"Data Source=.\\SqlExpress; Initial Catalog= APIEDUX; Persist Security Info=True;User ID=sa;Password=sa132";
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Data Source=.\\SqlExpress; Initial Catalog= APIEDUX; Persist Security Info=True;User ID=sa;Password=sa132");
            }
        }
